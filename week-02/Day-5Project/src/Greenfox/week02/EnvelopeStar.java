...
public class EnvelopeStar {
    public static void mainDraw(Graphics graphics) {
        for (int i = 0; i < 4; i++) {
            quartersOfEnvelope(0, 0, WIDTH, HEIGHT, i, graphics);
        }
    }

    public static void quartersOfEnvelope(int startX, int startY, int drawWidth, int drawHeight,
                                          int quarter, Graphics graphics) {
